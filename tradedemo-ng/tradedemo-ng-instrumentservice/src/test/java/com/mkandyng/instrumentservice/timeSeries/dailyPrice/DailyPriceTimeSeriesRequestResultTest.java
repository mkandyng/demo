...
/**
 *
 * Unit tests for {@link DailyPriceTimeSeriesRequestResult}
 *
 */

@RunWith(SpringRunner.class)
public class DailyPriceTimeSeriesRequestResultTest {
    ...
    public void shouldReturnTimeSeriesForMappedJSONPayload() throws IOException {
        Map<String, Map<String, Number>> timeSeries = getTimeSeries(DailyPriceTimeSeriesRequestResult.JSON_PROPERTY_MATCHVALUE);
    ...
    private Map<String, Map<String, Number>> getTimeSeries(String jsonProperty) throws IOException {
        ...
        DailyPriceTimeSeriesRequestResult result = new ObjectMapper().readValue(json, DailyPriceTimeSeriesRequestResult.class);
