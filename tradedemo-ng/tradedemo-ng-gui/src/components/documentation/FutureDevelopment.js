...
function FutureDevelopment(props) {
  return (
    <div>
      <p>The focus of this demo is on Javascript with React and techologies in its ecosystems.
         The next phase is to create the server side microservices to serve as template for building modern distributed reactive application.
      </p>
      <ul>
